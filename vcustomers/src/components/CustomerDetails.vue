<template>
  <div class="details container">
    ...
    <ul class="list-group">
      <li class="list-group-item"><span class="glyphicon glyphicon-tags"> {{customer.age}}</span></li>
    ...
    <ul class="list-group">
      <li class="list-group-item"><span class="glyphicon glyphicon-comment"> {{customer.profile}}</span></li>
    </ul>
  </div>
</template>
